...
return (
  ...
  <div className="bg-white rounded-xl shadow p-6 flex-1">
    <div className="flex justify-between items-center mb-4">
      <h2 className="text-xl font-semibold text-gray-800">Milk Production Analytics</h2>
      <select
        id="dateRange"
        value={dateRange}
  ...
  <div className="bg-white rounded-xl shadow p-6 w-full md:w-1/3">
      ...
      <p className="text-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow p-6 space-y-4">
            <h3 className="text-xl font-semibold text-gray-800">Environmental Conditions</h3>
            ...
            {/* Weather Forecast */}
            <h3 className="text-lg font-semibold text-gray-800 mt-4">Weather Forecast</h3>
    ...
    <button onClick={showModal}>Add cattle</button>
